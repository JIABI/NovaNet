...
TTL_SCALE = CFG.planner.ttl_reference_s
RATE_SCALE_MBPS = CFG.planner.rate_reference_mbps
...
L_UNCERT_W = CFG.training.nll_weight
L_TTL_W = 0.0  # TTL is propagated directly; there is no TTL predictor loss.
